...
#exporting data as csv for Laura
install.packages("xlsx")
library(xlsx)
write.csv(Cfirst1, "c:/Users/roussos/Dropbox/Research/Cfirst1.csv")
write.csv(study1, "c:/Users/roussos/Dropbox/Research/study1.csv")
write.csv(study2, "c:/Users/roussos/Dropbox/Research/study2.csv")
names(study1)
R.Version()

names(Cfirst1)
summary(Cfirst1$order)
...
#effect of voter (1=trump) among positive verbs; effect of verb(1=neg) among clinton voters 
model2<-glmer(response~(TrumpVoter*Negative)+ (1|verb)+ (1|WorkerID), data=Tfirst1, family=binomial)

#effect of verb(1=pos) among clinton voters 
model3<-glmer(response~(TrumpVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Tfirst1, family=binomial)

#effect of verb(1=pos) among trump voters
model4<-glmer(response~(ClintonVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Tfirst1, family=binomial)
...
#effect of voter (1=trump) among negative verbs; effect of verb(1=pos) among clinton voters 
model1<-glmer(response~(TrumpVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Tfirst2, family=binomial)

#effect of voter (1=trump) among positive verbs; effect of verb(1=neg) among clinton voters 
model2<-glmer(response~(TrumpVoter*Negative)+ (1|verb)+ (1|WorkerID), data=Tfirst2, family=binomial)

#effect of verb(1=pos) among clinton voters 
model3<-glmer(response~(TrumpVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Tfirst2, family=binomial)

#effect of verb(1=pos) among trump voters
model4<-glmer(response~(ClintonVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Tfirst2, family=binomial)
...
#effect of voter (1=trump) among positive verbs
model5<-glmer(response~(TrumpVoter*Negative)+ (1|verb)+ (1|WorkerID), data=Cfirst1, family=binomial)

#effect of voter (1=trump) among negative verbs
model6<-glmer(response~(TrumpVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Cfirst1, family=binomial)

#effect of verb(1=pos) among clinton voters 
model7<-glmer(response~(TrumpVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Cfirst1, family=binomial)

#effect of verb(1=pos) among trump voters
model8<-glmer(response~(ClintonVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Cfirst1, family=binomial)
...
#effect of voter (1=trump) among positive verbs
model5<-glmer(response~(TrumpVoter*Negative)+ (1|verb)+ (1|WorkerID), data=Cfirst2, family=binomial)

#effect of voter (1=trump) among negative verbs
model6<-glmer(response~(TrumpVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Cfirst2, family=binomial)

#effect of verb(1=pos) among clinton voters 
model7<-glmer(response~(TrumpVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Cfirst2, family=binomial)

#effect of verb(1=pos) among trump voters
model8<-glmer(response~(ClintonVoter*Positive)+ (1|verb)+ (1|WorkerID), data=Cfirst2, family=binomial)
